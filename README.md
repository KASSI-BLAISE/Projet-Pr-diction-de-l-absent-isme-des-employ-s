...
Données : Données RH tabulaires (740 employés, dataset Absenteeism at Work, UCI Machine Learning Repository)
...
```
📦 Données
Dataset : Absenteeism at Work (UCI Machine Learning Repository) — 740 enregistrements, 21 variables, données d'une entreprise de courrier brésilienne (juillet 2007 à juillet 2010).
